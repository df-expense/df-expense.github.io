...
$(document).ready(function () {
  ...
  // Initialize all generic carousel divs. The results carousel is configured separately below.
  ...
  var comparison_carousels = bulmaCarousel.attach("#results-carousel", comparison_options);
  carousels = carousels.concat(comparison_carousels);
  ...
  // Initialize all div with carousel class
  var double_carousels = bulmaCarousel.attach(".double_carousel", double_options);
